...
parser = argparse.ArgumentParser(prog='python3 PiStation.py', description='Broadcasts WAV/MP3 file over FM using RPI GPIO #4 pin.')
...
def main():
    ...
    if arg.frequency is None:
        ...
        if frequency == "":
            frequency = '103.3'
    elif not (87.1 <= arg.frequency <= 108.2):
